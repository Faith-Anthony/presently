...
// The color of this icon will be controlled by the parent CSS module
const CheckIcon = () => (
  <svg height="20" width="20" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
